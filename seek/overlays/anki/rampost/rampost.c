...
void set_body_leds(int success, int inRecovery)
{
  ...
  else {   // Anki DVT/dev: two blues in recovery, three blues on normal boot
...
int main(int argc, const char* argv[])
{
  ...
  bool is_dev_unit = true; // DVT look: always show PROPERTY OF ANKI splash
  ...
  if (spine_error) {
    // SeekOS: flaky/missing body must not block the head LCD (801/802 / 898/899).
