    ...
    if (otaUrls.length == 0) {
      ...
      if (!seekIsLocalWebsetup()) {
        speedBanner =
          ...
          "<b style=\"color:#7ddea2;font-size:15px;\">Fast install — all on this site</b><br/>" +
          "1. At the Wi‑Fi step, join Vector to your <b>home Wi‑Fi</b> (not the phone hotspot)<br/>" +
          "2. Tap <b>Seek OS (latest)</b> below — Vector downloads from Cloudflare on that Wi‑Fi<br/>" +
          "3. Leave this tab open until Vector reboots<br/>" +
          "<span style=\"opacity:0.85;font-size:12px;\">Phone hotspot uses cellular and is often 20–40&nbsp;min. Home Wi‑Fi is usually a few minutes. No apps or scripts.</span>" +
          "</div>";
      }
