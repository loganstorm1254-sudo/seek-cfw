    ...
    if (otaUrls.length == 0) {
      ...
      if (!seekIsLocalWebsetup()) {
        speedBanner =
          ...
          "<b style=\"color:#7ddea2;font-size:15px;\">Install on this site (~145&nbsp;MB)</b><br/>" +
          "1. Wi‑Fi step: join <b>home Wi‑Fi</b> (not phone hotspot)<br/>" +
          "2. Tap <b>Seek OS (latest)</b> — downloads from Cloudflare<br/>" +
          "3. Leave this tab open until Vector reboots<br/>" +
          "<span style=\"opacity:0.85;font-size:12px;\">Latest slim build is ~145&nbsp;MB (was ~217). Home Wi‑Fi is much faster than hotspot. No apps or scripts.</span>" +
          "</div>";
      }
