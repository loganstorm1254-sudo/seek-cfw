...
},{"./clad.js":3}],5:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./messageExternalComms.js":4,"./rtsCliUtil.js":5}],7:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./messageExternalComms.js":4,"./rtsCliUtil.js":5}],8:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./messageExternalComms.js":4,"./rtsCliUtil.js":5}],9:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./messageExternalComms.js":4,"./rtsCliUtil.js":5}],10:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./blesh.js":2,"./messageExternalComms.js":4,"./rtsCliUtil.js":5}],11:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
//**************** OTA (Seek: GitHub release URL from config.json) *******************
function setupOTAFiles() {
  var cfg = window.SEEK_CONFIG || {};
  var url = cfg.otaUrl || urlParams["otaUrl"];
  if (!url) {
  ...
  _otaEndpoint = url;
  pterm_set("OTA_URL", url);
  pterm_set("OTA_LKG", url);
  ...
  var label = cfg.label || cfg.version || url.split("/").pop();
  if ($("#seekOtaLabel").length) {
    $("#seekOtaLabel").text("Installing " + label + "…");
  }
...
function doOta() {
  if (rtsHandler == null) {
    console.log("doOta: no rts handler");
    return;
  }
  var url = getOtaUrl();
  if (!url) {
    $("#otaErrorLabel").removeClass("vec-hidden").text("No OTA URL configured.");
    $("#btnTryAgain").removeClass("vec-hidden");
    return;
  }
  rtsHandler.doOtaStart(url).then(
    function (msg) {
      console.log("ota started", msg);
    },
    function (msg) {
      console.log(msg);
...
$("#btnDiscoverVectorAgain").click(function () {
  cleanRtsHandler();
  toggleIcon("iconBle", false);
  toggleIcon("iconWifi", false);
...
},{"./clad.js":3,"./rtsCliUtil.js":5,"./rtsV2Handler.js":6,"./rtsV3Handler.js":7,"./rtsV4Handler.js":8,"./rtsV5Handler.js":9,"./rtsV6Handler.js":10,"./sessions.js":12,"./settings.js":13,"./stack.js":14,"./vectorBluetooth.js":15}],12:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
...
},{"./rtsCliUtil.js":5}],13:[function(require,module,exports){
/* Copyright (c) 2019-2020 Digital Dream Labs. See LICENSE file for details. */
